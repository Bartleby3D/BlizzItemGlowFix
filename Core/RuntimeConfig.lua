...
function RuntimeConfig.BuildSnapshot()
    ...
    return {
        ...
        ilvlOffsetX = tonumber(NS.GetConfig("ilvlOffsetX", 0, "Global")) or 0,
        ...
        junkIconEnabled = NS.GetConfig("junkIconEnabled", true, "Global") == true,
        junkIconSize = NS.GetConfigClamped("junkIconSize", 15, 8, 32, "Global"),
        junkIconOffsetX = tonumber(NS.GetConfig("junkIconOffsetX", -9, "Global")) or -9,
        junkIconOffsetY = tonumber(NS.GetConfig("junkIconOffsetY", 9, "Global")) or 9,
        ...
        questIconEnabled = NS.GetConfig("questIconEnabled", false, "Global") == true,
        questIconSize = NS.GetConfigClamped("questIconSize", 15, 8, 32, "Global"),
        questIconOffsetX = tonumber(NS.GetConfig("questIconOffsetX", 11, "Global")) or 11,
        questIconOffsetY = tonumber(NS.GetConfig("questIconOffsetY", 10, "Global")) or 10,
